...
// Database initialization - for Vercel, we'll use a temporary database
// In production, you'd want to use a persistent database service
let db;
if (process.env.NODE_ENV === 'production') {
  // In production, we might connect to a cloud database
  // For now, we'll use an in-memory database for serverless compatibility
...
app.get('/api/staff', authenticateToken, (req, res) => {
  const query = 'SELECT id, username, email FROM users WHERE role = "staff" ORDER BY username';
