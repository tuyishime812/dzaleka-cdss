...
let users = [
  { id: 1, username: 'admin', email: 'admin@school.edu', password_hash: '', role: 'admin' },
  { id: 2, username: 'emmanuel', email: 'emmanuel@staff.edu', password_hash: '', role: 'staff' },
  { id: 3, username: 'tuyishime', email: 'tuyishime@staff.edu', password_hash: '', role: 'staff' },
  { id: 4, username: 'martin', email: 'martin@student.edu', password_hash: '', role: 'student' },
  { id: 5, username: 'shift', email: 'shift@student.edu', password_hash: '', role: 'student' },
  { id: 6, username: 'emmanuel_student', email: 'emmanuel_student@student.edu', password_hash: '', role: 'student' },
  { id: 7, username: 'tuyishime_student', email: 'tuyishime_student@student.edu', password_hash: '', role: 'student' }
];
...
const initializeUsers = async () => {
  ...
  users[0].password_hash = adminHash;

  // Hash staff passwords
  const staffHash = await bcrypt.hash('staff123', 10);
  users[1].password_hash = staffHash;
  users[2].password_hash = staffHash;
  ...
  users[6].password_hash = studentHash;
};
