// Fixed server for Render deployment with pre-hashed passwords
...
const ADMIN_PASSWORD_HASH = '$2a$10$XOPbrlUPQd3aRHhpjqcQxeqRQ3GHOJ64C1zFeY6H9.hbbEyGFUoqe';
// staff123 hashed with bcrypt
const STAFF_PASSWORD_HASH = '$2a$10$XOPbrlUPQd3aRHhpjqcQxeqRQ3GHOJ64C1zFeY6H9.hbbEyGFUoqe';
// student123 hashed with bcrypt
const STUDENT_PASSWORD_HASH = '$2a$10$XOPbrlUPQd3aRHhpjqcQxeqRQ3GHOJ64C1zFeY6H9.hbbEyGFUoqe';

// In-memory storage for users with pre-hashed passwords
let users = [
  { id: 1, username: 'admin', email: 'admin@school.edu', password_hash: ADMIN_PASSWORD_HASH, role: 'admin' },
  { id: 2, username: 'emmanuel', email: 'emmanuel@staff.edu', password_hash: STAFF_PASSWORD_HASH, role: 'staff' },
  { id: 3, username: 'tuyishime', email: 'tuyishime@staff.edu', password_hash: STAFF_PASSWORD_HASH, role: 'staff' },
  { id: 4, username: 'martin', email: 'martin@student.edu', password_hash: STUDENT_PASSWORD_HASH, role: 'student' },
  { id: 5, username: 'shift', email: 'shift@student.edu', password_hash: STUDENT_PASSWORD_HASH, role: 'student' },
  { id: 6, username: 'emmanuel_student', email: 'emmanuel_student@student.edu', password_hash: STUDENT_PASSWORD_HASH, role: 'student' },
  { id: 7, username: 'tuyishime_student', email: 'tuyishime_student@student.edu', password_hash: STUDENT_PASSWORD_HASH, role: 'student' }
];
...
const authenticateToken = (req, res, next) => {
  ...
  jwt.verify(token, process.env.JWT_SECRET || 'fallback_secret_key_for_development', { 
    algorithms: ['HS256'],
    ...
    // Additional security check: ensure user exists in memory
...
app.get('/api/grades/student/:studentId', authenticateToken, (req, res) => {
  ...
  const studentGrades = grades.filter(grade => grade.student_id === sanitizedStudentId);
...
app.get('/api/admin/grade-analytics', authenticateToken, requireAdmin, (req, res) => {
  ...
  }).slice(0, 100); // Limit to last 100 grades
